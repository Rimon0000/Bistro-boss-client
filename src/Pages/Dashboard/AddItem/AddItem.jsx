    ...
    return (
        <div className='w-full px-10'>
            ...
            <div className="form-control w-full ">
              ...
              <input type="text" placeholder="name" {...register("name", {required: true, maxLength: 120})} className="input input-bordered w-full " />
            </div>
            ...
            <input type="submit" className='btn btn-sm mb-4' value="Add Item" />
            </form>
        </div>
    );
};
