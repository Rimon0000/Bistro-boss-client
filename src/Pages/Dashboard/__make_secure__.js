 ...
 * 2. Do not allow to visit the link by typing on the url. use
 *    AdminRoute that will check whether the user is admin or not.
 ...
 *         TO SEND DATA
 * -----------------------------
 * 1. verify jwt token(send authorization token in the header to the server). If possible
 *    use axios to send jwt token by intercepting the request. 
